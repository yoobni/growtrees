                                    ...
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        {{-- @foreach ($introLines as $line) --}}
                                            <p style="{{ $style['paragraph'] }}">
                                                회원님의 비밀번호 찾기 요청에 의해서 메일을 보내게 되었습니다. 아래의 버튼을 누르면 비밀번호 재설정을 할 수 있는 페이지로 이동할 수 있습니다.{{-- $line --}}
                                            </p>
                                        {{-- @endforeach --}}
                                        ...
                                        {{-- @foreach ($outroLines as $line) --}}
                                            <p style="{{ $style['paragraph'] }}">
                                               비밀번호 찾기 요청을 하지 않았다면 다른 사용자가 비정상적인 접근을 하려했을 수 있습니다. 보안을 강화하기 위해서 현재 이메일의 비밀번호를 바꿔주세요.{{-- $line --}}
                                            </p>
                                        {{-- @endforeach --}}
                                                ...
                                                <tr>
                                                    <td style="{{ $fontFamily }}">
                                                        <p style="{{ $style['paragraph-sub'] }}">
                                                            버튼이 클릭되지 않는다면 아래의 링크를 브라우저에 복사 붙여넣기 해보세요:
                                                        </p>
